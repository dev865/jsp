            ...
            <div class="container">
                ...
                <div class="navbar-collapse offcanvas-collapse" id="navbarsExampleDefault">
                    <ul class="navbar-nav ms-auto navbar-nav-scroll">
                        ...
                        <li class="nav-item">
                            <a class="nav-link" href="/prd/register">Product Register</a>
                        </li>
                        <li class="nav-item">
                    ...
                    <span class="nav-item">
                        <a class="btn-outline-sm" href="/mem/login">Log in</a>
                    </span>
                    </c:if>
                    <c:if test="${ses.email ne null && ses.email ne '' }">
                    <span class="nav-item">
                        <a class="btn-outline-sm" href="/mem/detail?em=${ses.email }">${ses.nick_name }</a>
                    </span>
                    </c:if>
