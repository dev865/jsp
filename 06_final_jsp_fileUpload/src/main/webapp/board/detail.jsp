		...
		<div class="modal-content">
			<div class="row">
				...
				<div class="col-lg-8">
					...
					<button type="button" class="btn btn-outline-danger" id="fileDelBtn">Image DEL</button>
					<button type="button" class="btn btn-outline-danger" id="fileTotalDelBtn">File DEL</button>
					<!-- end of image-container -->
				</div>
				<!-- end of col -->
				<div class="col-lg-4">
